...
{
    public class Coded_ApplyForLoanActivity : System.Activities.Activity
    {
        public Coded_ApplyForLoanActivity()
        {
            this.Implementation = () =>
            {
                return new Coded_ApplyForLoanActivityChild()
                {};
            };
        }
    }

    internal class Coded_ApplyForLoanActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public Coded_ApplyForLoanActivityChild()
        {
            DisplayName = "Coded_ApplyForLoan";
        }
        ...
        {
            var codedWorkflow = new global::_360DegreeTestSuiteDemo.CODEDTESTCASES.Coded_ApplyForLoan();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\Coded_ApplyForLoan.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\Coded_ApplyForLoan.cs", Exception = exception});
                }
