...
{
    public class DemoActivity : System.Activities.Activity
    {
        public DemoActivity()
        {
            this.Implementation = () =>
            {
                return new DemoActivityChild()
                {};
            };
        }
    }

    internal class DemoActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public DemoActivityChild()
        {
            DisplayName = "Demo";
        }
        ...
        {
            var codedWorkflow = new global::_360DegreeTestSuiteDemo.CODEDTESTCASES.Demo();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\Demo.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\Demo.cs", Exception = exception});
                }
