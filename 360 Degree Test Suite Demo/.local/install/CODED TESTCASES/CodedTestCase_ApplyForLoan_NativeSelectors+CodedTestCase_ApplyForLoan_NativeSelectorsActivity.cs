...
{
    public class CodedTestCase_ApplyForLoan_NativeSelectorsActivity : System.Activities.Activity
    {
        public CodedTestCase_ApplyForLoan_NativeSelectorsActivity()
        {
            this.Implementation = () =>
            {
                return new CodedTestCase_ApplyForLoan_NativeSelectorsActivityChild()
                {};
            };
        }
    }

    internal class CodedTestCase_ApplyForLoan_NativeSelectorsActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public CodedTestCase_ApplyForLoan_NativeSelectorsActivityChild()
        {
            DisplayName = "CodedTestCase_ApplyForLoan_NativeSelectors";
        }
        ...
        {
            var codedWorkflow = new global::_360DegreeTestSuiteDemo.CODEDTESTCASES.CodedTestCase_ApplyForLoan_NativeSelectors();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\CodedTestCase_ApplyForLoan_NativeSelectors.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\CodedTestCase_ApplyForLoan_NativeSelectors.cs", Exception = exception});
                }
