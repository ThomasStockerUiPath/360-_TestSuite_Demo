...
{
    public class Click_OptionsActivity : System.Activities.Activity
    {
        public Click_OptionsActivity()
        {
            this.Implementation = () =>
            {
                return new Click_OptionsActivityChild()
                {};
            };
        }
    }

    internal class Click_OptionsActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public Click_OptionsActivityChild()
        {
            DisplayName = "Click_Options";
        }
        ...
        {
            var codedWorkflow = new global::_360DegreeTestSuiteDemo.CODEDTESTCASES.Selectors.Click_Options();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\Selectors\\Click Options.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\Selectors\\Click Options.cs", Exception = exception});
                }
