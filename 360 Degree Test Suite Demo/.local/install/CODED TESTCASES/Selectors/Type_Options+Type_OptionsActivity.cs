...
{
    public class Type_OptionsActivity : System.Activities.Activity
    {
        public Type_OptionsActivity()
        {
            this.Implementation = () =>
            {
                return new Type_OptionsActivityChild()
                {};
            };
        }
    }

    internal class Type_OptionsActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public Type_OptionsActivityChild()
        {
            DisplayName = "Type_Options";
        }
        ...
        {
            var codedWorkflow = new global::_360DegreeTestSuiteDemo.CODEDTESTCASES.Selectors.Type_Options();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\Selectors\\Type_Options.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\Selectors\\Type_Options.cs", Exception = exception});
                }
