...
{
    public class Coded_Apply_for_loanActivity : System.Activities.Activity
    {
        public Coded_Apply_for_loanActivity()
        {
            this.Implementation = () =>
            {
                return new Coded_Apply_for_loanActivityChild()
                {};
            };
        }
    }

    internal class Coded_Apply_for_loanActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public Coded_Apply_for_loanActivityChild()
        {
            DisplayName = "Coded_Apply_for_loan";
        }
        ...
        {
            var codedWorkflow = new global::_360DegreeTestSuiteDemo.CODEDTESTCASES.Coded_Apply_for_loan();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\Coded_Apply for loan.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CODED TESTCASES\\Coded_Apply for loan.cs", Exception = exception});
                }
